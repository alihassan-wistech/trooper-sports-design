<?php include 'header.php'; ?>
                    ...
                    <div class="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 w-full text-white h-full flex items-center">
                        <div class="max-w-3xl">
                            ...
                            <div class="mt-10 flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="#" class="btn btn-outline-light btn-md">
    ...
    <section class="py-20 lg:py-24 bg-light border-b border-black">
        <div class="max-w-[1440px] mx-auto px-6 lg:px-12">
            ...
            <div class="mt-16 text-center">
                <a href="#" class="inline-flex items-center gap-2 text-black hover:text-gray-600 text-[18px] font-bold tracking-[0.02em] hover:underline underline-offset-4 transition-all">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <article class="group border border-black bg-light transition-all duration-300 hover:bg-dark">
                    ...
                    <div class="p-8">
                        ...
                        <a href="/product-detail.html?category=team-uniforms" class="mt-6 btn btn-light btn-sm btn-fixed-on-group">
                ...
                <article class="group border border-black bg-light transition-all duration-300 hover:bg-dark">
                    ...
                    <div class="p-8">
                        ...
                        <a href="/product-detail.html?category=team-apparel" class="mt-6 btn btn-light btn-sm btn-fixed-on-group">
                ...
                <article class="group border border-black bg-light transition-all duration-300 hover:bg-dark">
                    ...
                    <div class="p-8">
                        ...
                        <a href="/product-detail.html?category=club-merchandise" class="mt-6 btn btn-light btn-sm btn-fixed-on-group">
    ...
    <section class="py-20 lg:py-24 bg-white text-dark relative overflow-hidden border-b border-black">
