...
<head>
    ...
    <title>Troopers Sports – Premium Factory-Direct Custom Sportswear</title>
    ...
    <nav class="sticky top-0 z-50 bg-white border-b border-gray shadow-sm">
        <div class="max-w-[1440px] mx-auto px-6 lg:px-12 py-5 flex items-center justify-between">
            ...
            <a href="/" class="flex items-center">
                <img src="images/logo.png" alt="Troopers Sports logo" class="h-10 w-auto">
            </a>
            ...
            <ul class="hidden lg:flex items-center gap-x-8 text-neutral-dark font-medium">
                ...
                <li><a href="#" class="hover:text-black transition-colors">What We Build</a></li>
                <li><a href="#" class="hover:text-black transition-colors">Our Process</a></li>
        ...
        <div id="mobileMenuPanel" class="lg:hidden hidden border-t border-gray bg-white">
            <div class="max-w-[1440px] mx-auto px-6 py-4">
                <ul class="flex flex-col gap-3 text-neutral-dark font-medium">
                    <li><a href="#" class="block py-2 hover:text-black transition-colors">Home</a></li>
                    <li><a href="#" class="block py-2 hover:text-black transition-colors">What We Build</a></li>
                    <li><a href="#" class="block py-2 hover:text-black transition-colors">Our Process</a></li>
                    <li><a href="#" class="block py-2 hover:text-black transition-colors">About Us</a></li>
                    <li><a href="#" class="block py-2 hover:text-black transition-colors">Contact</a></li>
                </ul>
